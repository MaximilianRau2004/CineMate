...
const Dashboard = ({ data }) => (
  <div className="row">
    {[
      ...
      { title: "Schauspieler gesamt", count: data.actors.length, color: "danger", icon: FaUserTie },
      { title: "Regisseure gesamt", count: data.directors.length, color: "secondary", icon: FaUserTie }
